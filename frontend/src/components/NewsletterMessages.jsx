  ...
  return (
    <div className={cx( classes, {'invisible': ! visible && hasVisibilityToggle} )}>
      <div className="inline-flex rounded-md shadow-sm ml-8">
        <div
          className={cx(contentColorClass, 'inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md text-black active:transition ease-in-out duration-150 cursor-not-allowed')}
        >
          { showSpinner ? (
            <svg className={cx(contentColorClass, 'animate-spin -ml-1 mr-3 h-5 w-5')
