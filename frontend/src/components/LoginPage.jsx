          ...
          <div className="overlay-container">
            <div className="overlay">
              <div className="overlay-panel overlay-register">
                ...
                <a className='a'>Si todavía no te has registrado, puedes</a> <a className='a'>hacerlo para tener una experiencia</a> <a className='a'>personalizada y enterarte de todo lo que está pasando.</a>
